...
//Defines the Customer object that will be used to carry 
//data about a customer in customer and transaction classes
public class Customer {

	//Each variable corresponds to a column
	//found in table cdw_sapp_customer in CDW_SAPP database
